...
export const checkBudgetAlert = inngest.createFunction(
  ...
  async ({ step }) => {
    ...
    // Check if budgets is an array and not null/undefined
    if (!Array.isArray(budgets) || budgets === null) {
      // console.error("Invalid budgets data:", budgets);
      return; // Exit if budgets is invalid
    }
...
export const processRecurringTranscation = inngest.createFunction(
  {
